...
const ProfileEdit = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (image) {
      ...
      response = await updateUser(user?.id!, { username, about });
    }
  ...
  return (
    <section>
      ...
      <form
        className="w-full flex flex-col items-center justify-around py-5"
      ...
      >
        <div className="flex md:flex-row flex-col">
          ...
          <div className="md:pl-5 flex flex-col justify-center md:mt-0 mt-5">
            <p className="md:text-start text-center">
              {name ? name.slice(0, 20) + "..." : "No image selected."}
            </p>
            <button
        ...
        <div className="mt-10 flex flex-col md:w-[400px]">
          ...
          />
          <label className="text-xl font-semibold mt-5" htmlFor="about">
            About:
          </label>
          <textarea
            spellCheck={false}
