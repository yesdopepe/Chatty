...
const ChannelForm = () => {
  ...
  return (
    <form
      action="POST"
      className="max-w-[800px] px-3 mx-auto overflow-y-auto overflow-x-hidden"
      onSubmit={handleSubmit}
    >
      <div className="flex items-center justify-center w-full lg:flex-row flex-col py-5 border-b border-neutral-600">
        <LazyLoadImage
          className={`rounded-full w-52 h-52 object-cover cursor-pointer duration-200 ${
            !image && "border-2 border-neutral-600 hover:bg-neutral-700"
          }`}
          src={image}
          alt="ch"
          onClick={handleClick}
